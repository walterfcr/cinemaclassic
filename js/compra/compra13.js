...
function compra(){
    ...
    let precio = checkSeleccionados.length * 2500;
    let checkSeleccionadosVip = document.querySelectorAll('input[name="butacas2"]:checked');
    let precioVip = checkSeleccionadosVip.length * 4500;
    ...
    for(let i = 0; i < checkboxes2.length; i++)
    {
        ...
        outputResultado4.innerHTML = "precio unitario: ¢2500" + "<br>" + "Total: " + "¢" + precio;
        outputResultado5.innerHTML = "La cantidad de entradas VIP son: " + checkSeleccionadosVip.length; 
        outputResultado6.innerHTML = "precio unitario: ¢4500" + "<br>" + "Total: " + "¢" + precioVip;
...
function pagar() {
    let outputResultado11 = document.querySelector('#outnResultado11');
...
}else if(fechaExpiracion = '' || fechaExpiracion == null || fechaExpiracion == undefined){
    ...
    outputResultado11.innerHTML = "pago exitoso";
}
}