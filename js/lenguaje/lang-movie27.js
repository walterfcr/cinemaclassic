...
let changeLanguage = {
    ...
    "spanish":
    {
        ...
        "langReparto": "Reparto",
        "langPais": "País: ",
        "langPais2": "Estados Unidos",
        "langYear": "Año: ",
        "langPlot": "Sipnosis: ",
        "langPlot2": "Max es un matemático que está a punto de decodificar el sistema numérico del mercado bursátil. Sin embargo, antes debe encontrar el valor del número pi. Una firma de Wall Street y una secta judía perseguirán a Max para quedarse con su descubrimiento.",
        "volver": "Volver",
        "comprar": "Comprar",
        "footerHome": "Inicio",
  ...
  //objeto de json que asigna los valores a cada clase en ingles  
    "english":
    {
        ...
        "langReparto": "Cast",
        "langPais": "Country: ",
        "langPais2": "United States",
        "langYear": "Year: ",
        "langPlot": "Plot: ",
        "langPlot2": "Max is a mathematician who is about to decode the stock market number system. However, you must first find the value of the number pi. A Wall Street firm and a Jewish sect will persecute Max to keep his discovery.",
        "volver": "Previous",
        "comprar": "Buy Tiquets",
        "footerHome": "Home",
