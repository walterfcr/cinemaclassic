...
let changeLanguage = {
    ...
    "spanish":
    {
        ...
        "langYear": "Año: ",
        "langPlot": "Sipnosis: ",
        "langPlot2": "Un veterano ladrón de bancos decide preparar un último y sofisticado robo con la intención de retirarse, pero un policía de métodos expeditivos, cuya vida privada es una pesadilla, se propone impedírselo.",
        "volver": "Volver",
        "comprar": "Comprar",
        "footerHome": "Inicio",
  ...
  //objeto de json que asigna los valores a cada clase en ingles  
    "english":
    {
        ...
        "langYear": "Year: ",
        "langPlot": "Plot: ",
        "langPlot2": "A veteran robber decides to stage one last sophisticated bank robbery with the intention of retiring, but a quick-witted cop, whose private life is a nightmare, sets out to stop him.",
        "volver": "Previous",
        "comprar": "Buy Tiquets",
        "footerHome": "Home",
