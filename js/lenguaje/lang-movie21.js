...
let changeLanguage = {
    ...
    "spanish":
    {
        ...
        "langYear": "Año: ",
        "langPlot": "Sipnosis: ",
        "langPlot2": "Dae-Su es un hombre de negocios que, sin motivo aparente, es secuestrado y confinado en una celda con la única compañía de un televisor. Quince años más tarde, es liberado junto a una gran cantidad de dinero y un teléfono celular.",
        "volver": "Volver",
        "comprar": "Comprar",
        "footerHome": "Inicio",
  ...
  //objeto de json que asigna los valores a cada clase en ingles  
    "english":
    {
        ...
        "langYear": "Year: ",
        "langPlot": "Plot: ",
        "langPlot2": "Dae-Su is a businessman who, for no apparent reason, is kidnapped and confined to a cell with the only company of a television. Fifteen years later, he is released along with a large amount of money and a cell phone.",
        "volver": "Previous",
        "comprar": "Buy Tiquets",
        "footerHome": "Home",
