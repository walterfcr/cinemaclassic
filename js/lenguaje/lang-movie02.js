...
link.forEach(r => {
    r.addEventListener('click', () => {
        ...
        trailer.textContent = changeLanguage[attr].trailer;
...
let changeLanguage = {
    ...
    "spanish":
    {
        ...
        "langYear": "Año: ",
        "langPlot": "Sipnosis: ",
        "langPlot2": "Los superhéroes Scott y Cassie Lang, Hope van Dyne y sus padres, se encuentran accidentalmente atrapados en el reino cuántico y deben enfrentarse a un nuevo enemigo, Kang el Conquistador.",
        "volver": "Volver",
        "trailer": "Ver tráiler",
        "comprar": "Comprar",
        "footerHome": "Inicio",
  ...
  //objeto de json que asigna los valores a cada clase en ingles  
    "english":
    {
        ...
        "langYear": "Year: ",
        "langPlot": "Plot: ",
        "langPlot2": "Superheroes Scott and Cassie Lang, Hope van Dyne and her parents, accidentally find themselves trapped in the quantum realm and must face a new enemy, Kang the Conqueror.",
        "volver": "Previous",
