...
let changeLanguage = {
    ...
    "spanish":
    {
        ...
        "langYear": "Año: ",
        "langPlot": "Sipnosis: ",
        "langPlot2": "Juan y Marcos son dos estafadores que casualmente se ven involucrados en un asunto que los puede convertir en millonarios: tienen menos de un día para llevar a cabo un engaño que no puede fallar.",
        "volver": "Volver",
        "comprar": "Comprar",
        "footerHome": "Inicio",
  ...
  //objeto de json que asigna los valores a cada clase en ingles  
    "english":
    {
        ...
        "langYear": "Year: ",
        "langPlot": "Plot: ",
        "langPlot2": "Juan and Marcos are two swindlers who coincidentally find themselves involved in a matter that could make them millionaires: they have less than one day to carry out a con that cannot fail.",
        "volver": "Previous",
        "comprar": "Buy Tiquets",
        "footerHome": "Home",
